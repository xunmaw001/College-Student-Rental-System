  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="24">  
        <el-form-item v-if="flag=='fangzhu'" label="照片" prop="zhaopian">
          <file-upload
          tip="点击上传照片"
          action="file/upload"
          :limit="3"
          ...
          @change="fangzhuzhaopianUploadChange"
          ></file-upload>
        </el-form-item>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    fangzhuzhaopianUploadChange(fileUrls) {
    ...
    onUpdateHandler() {
      ...
      if((!this.ruleForm.lianxidianhua)&& 'fangzhu'==this.flag){
      ...
      if((!this.ruleForm.shenfenzheng)&& 'fangzhu'==this.flag){
