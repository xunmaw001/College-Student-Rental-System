  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.fangwushipin" label="房屋视频" prop="fangwushipin">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.fangwushipin)">预览</el-button>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="房屋介绍" prop="fangwujieshao">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.fangwujieshao" label="房屋介绍" prop="fangwujieshao">
                    <span v-html="ruleForm.fangwujieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
		...
		if(json.fangzhuxingming!=''&&json.fangzhuxingming){
	...
	this.ruleForm.fangwujieshao = this.ruleForm.fangwujieshao.replace(reg,'../../../springboots9331/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
