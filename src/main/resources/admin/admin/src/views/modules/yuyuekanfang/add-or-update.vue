<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="预约备注" prop="yuyuebeizhu">
          <el-input v-model="ruleForm.yuyuebeizhu" 
              placeholder="预约备注" clearable  :readonly="ro.yuyuebeizhu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="预约备注" prop="yuyuebeizhu">
              <el-input v-model="ruleForm.yuyuebeizhu" 
                placeholder="预约备注" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
