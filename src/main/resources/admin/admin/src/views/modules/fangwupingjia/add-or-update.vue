    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="房屋评分" prop="fangwupingfen">
          <el-select :disabled="ro.fangwupingfen" v-model="ruleForm.fangwupingfen" placeholder="请选择房屋评分">
            <el-option
...
export default {
  ...
  methods: {
	...
	this.ruleForm.fangwupingjia = this.ruleForm.fangwupingjia.replace(reg,'../../../springboots9331/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
