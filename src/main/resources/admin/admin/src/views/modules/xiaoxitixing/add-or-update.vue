<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="通知标题" prop="tongzhibiaoti">
          <el-input v-model="ruleForm.tongzhibiaoti" 
              placeholder="通知标题" clearable  :readonly="ro.tongzhibiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="通知标题" prop="tongzhibiaoti">
              <el-input v-model="ruleForm.tongzhibiaoti" 
