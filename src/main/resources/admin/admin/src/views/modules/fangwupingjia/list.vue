  ...
  <div class="main-content">
    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
		...
		<el-form-item class="select" label="房屋评分" prop="fangwupingfen">
		  <el-select  @change="fangwupingfenChange" clearable v-model="searchForm.fangwupingfen" placeholder="请选择房屋评分">
		    <el-option
    ...
    getDataList() {
      ...
      let params = {
        ...
        sort: 'id',
          ...
          if(this.searchForm.fangwupingfen!='' && this.searchForm.fangwupingfen!=undefined){
            params['fangwupingfen'] = this.searchForm.fangwupingfen
          }
      this.$http({
